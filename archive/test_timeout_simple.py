#!/usr/bin/env python3
"""
Тест простого Time Out Bangkok фетчера с корректными заголовками
"""
...
from tools.fetchers.timeout_bkk_simple import fetch

def test_timeout_simple():
    print("🔥 Тестируем простой Time Out Bangkok фетчер...")
    ...
    try:
        ...
        if events:
            ...
            for i, event in enumerate(events):
                ...
                print(f"     Price: {event.get('price_min', 'No price')}")
