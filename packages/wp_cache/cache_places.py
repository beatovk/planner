...
def cache_places_stale(city: str, flag: str, places: List[Place], ttl: int = 86400) -> bool:
    """
...
def warm_places_cache(city: str, flags: List[str], fetcher, ttl: int = 3600) -> Dict[str, int]:
    """
        ...
        try:
            ...
            if places:
                ...
                if success:
                    ...
                    logger.info(f"Successfully cached {len(places)} places for {city}:{flag}")
                else:
                    results[flag] = 0
