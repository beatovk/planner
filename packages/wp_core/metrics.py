...
class Metrics:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_cache_read_ms": sum(self.cache_reads) / len(self.cache_reads) if self.cache_reads else 0,
            "avg_db_read_ms": sum(self.db_reads) / len(self.db_reads) if self.db_reads else 0
        }
