...
def test_build_week_cards_from_places():
    ...
    places = [
        Place(id="1", name="Live Music Club", city="Bangkok",
              tags=["live music", "nightlife"], typical_time="evening", source="mock"),
        Place(id="2", name="Street Food Market", city="Bangkok",
              tags=["street food", "market"], typical_time="day", source="mock"),
        Place(id="3", name="Art Gallery", city="Bangkok",
              tags=["art", "exhibition"], typical_time="day", source="mock"),
    ]
...
def test_build_day_cards_from_places():
    ...
    result = build_day_cards_from_places(places, "Bangkok", ["music", "food"], "2024-01-01")
...
def test_cards_with_different_tags():
    ...
    places = [
        Place(id="1", name="Jazz Club", city="Bangkok",
              tags=["jazz", "music"], typical_time="evening", source="mock"),
        Place(id="2", name="Thai Restaurant", city="Bangkok",
              tags=["thai food", "restaurant"], typical_time="day", source="mock"),
        Place(id="3", name="Shopping Mall", city="Bangkok",
              tags=["shopping", "mall"], typical_time="day", source="mock"),
    ]
    
    # Тест с тегом "music"
    music_result = build_day_cards_from_places(places, "Bangkok", ["music"], "2024-01-01")
    ...
    shopping_result = build_day_cards_from_places(places, "Bangkok", ["shopping"], "2024-01-01")
...
def test_cards_scoring():
    ...
    places = [
        Place(id="1", name="Live Music Venue", city="Bangkok",
              tags=["live music"], typical_time="evening", source="mock"),
        Place(id="2", name="Jazz Bar", city="Bangkok",
              tags=["jazz", "music"], typical_time="evening", source="mock"),
        Place(id="3", name="General Bar", city="Bangkok",
              tags=["bar"], typical_time="evening", source="mock"),
    ]
