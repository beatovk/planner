...
class TestTagGrammarEngine(unittest.TestCase):
    ...
    def test_synonym_mapping(self):
        ...
        self.assertEqual(self.engine.find_tag_by_synonym("สวนสาธารณะ"), "outdoor_recreation")
        self.assertEqual(self.engine.find_tag_by_synonym("โรงแรม"), "accommodation")
        self.assertEqual(self.engine.find_tag_by_synonym("รถไฟฟ้าบีทีเอส"), "transportation")
    ...
    def test_tag_validation(self):
        ...
        # No level A tags
        validation = self.engine.validate_tags(["outdoor_recreation", "business_services"])
        self.assertFalse(validation['is_valid'])
    ...
    def test_tag_combinations(self):
        ...
        # Good combination
        validation = self.engine.validate_tags(["food_dining", "nightlife"])
        self.assertTrue(any("Good tag combination" in suggestion for suggestion in validation['suggestions']))
    ...
    def test_performance(self):
        ...
        # Large tag set
        large_tag_set = ["food_dining", "nightlife", "shopping", "culture_arts", "wellness_health"] * 100
    ...
    def test_synonym_uniqueness(self):
        ...
        self.assertEqual(len(en_lower), len(set(en_lower)), "Duplicate EN synonyms found")
        self.assertEqual(len(th_lower), len(set(th_lower)), "Duplicate TH synonyms found")
