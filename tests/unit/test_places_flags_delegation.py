...
class TestPlacesServiceFlagsDelegation:
    ...
    def test_get_places_by_category_delegates_to_shared_mapper(self, mock_categories_to_flags):
        ...
        with patch.object(service, '_get_cached_places') as mock_get_cached:
            ...
            with patch('core.places_service.get_places_by_flags') as mock_db_get:
    ...
    @patch('core.query.place_facets.map_place_to_flags')
    def test_place_flags_mapping_delegates_to_shared_mapper(self, mock_map_to_flags):
        ...
        from core.query.place_facets import map_place_to_flags
    ...
    def test_place_facets_imports_shared_mapper(self):
        ...
        assert 'from core.query.facets import' in content, "place_facets.py should import from shared facets.py"
    ...
    def test_fallback_implementation_exists(self):
        ...
        from core.query.place_facets import _fallback_map_place_to_flags, _fallback_categories_to_place_flags
