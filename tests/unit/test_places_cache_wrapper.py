...
class TestPlacesServiceCacheWrapper:
    ...
    def test_places_service_uses_shared_cache(self, mock_ensure_client, mock_is_configured):
    ...
    @patch('core.places_service.is_configured')
    @patch('core.places_service.ensure_client')
    def test_cache_places_calls_shared_cache(self, mock_ensure_client, mock_is_configured):
    ...
    @patch('core.places_service.is_configured')
    @patch('core.places_service.ensure_client')
    def test_get_cached_places_calls_shared_cache(self, mock_ensure_client, mock_is_configured):
    ...
    def test_cache_key_format_matches_v1_spec(self):
        ...
        # Test key formats
        assert service._get_place_cache_key("bangkok", "food_dining") == "v1:places:bangkok:flag:food_dining"
        assert service._get_place_cache_key("chiang_mai", "art_exhibits") == "v1:places:chiang_mai:flag:art_exhibits"
        assert service._get_place_stale_key("bangkok", "rooftop") == "v1:places:bangkok:flag:rooftop:stale"
