...
def test_planner_with_smart_tag_matching():
    ...
    places = [
        ...
        Place(id="4", name="Rooftop Bar", city="Bangkok", 
              tags=["cocktails"], typical_time="evening", source="mock"),
        Place(id="5", name="Outdoor Park", city="Bangkok", 
              tags=["park"], typical_time="day", source="mock"),
    ]
...
def test_planner_scoring_order():
    ...
    places = [
        Place(id="1", name="Music Club", city="Bangkok", 
              tags=["music"], typical_time="evening", source="mock"),
        Place(id="2", name="Live Music Venue", city="Bangkok", 
              tags=["live music"], typical_time="evening", source="mock"),
        Place(id="3", name="Jazz Bar", city="Bangkok", 
